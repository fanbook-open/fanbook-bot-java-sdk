...
import com.idreamsky.fanbook.sdk.bot.model.v20220429.GuildCredit;
...
/**
 * 通过这个方法为服务台用户或者是群用户设置服务台荣誉数据
 *
 * @author peng.gan
 */
@Data
@Slf4j
public class SetCreditMethod extends BotMethod<Boolean> {
    ...
    @SerializedName("guild_credit")
    private GuildCredit guildCredit;
    ...
    public void validate() throws BotArgumentException {
        ...
        if (null == guildCredit) {
            throw new BotArgumentException("guildCredit must not be null");
        }
