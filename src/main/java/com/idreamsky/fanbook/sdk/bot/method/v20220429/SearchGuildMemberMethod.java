...
/**
 * 通过这个方法可按照用户昵称、服务器昵称搜索服务台用户
 *
 * @author peng.gan
 */
@Data
@Slf4j
public class SearchGuildMemberMethod extends BotMethod<ArrayList<ChatMember>> {
    ...
    public void validate() throws BotArgumentException {
        ...
        if (null == query || query.isEmpty()) {
            throw new BotArgumentException("query must not be empty");
        }
    }
}
