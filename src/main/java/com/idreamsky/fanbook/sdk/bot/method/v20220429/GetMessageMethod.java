...
@NoArgsConstructor
@Builder
public class GetMessageMethod extends BotMethod<Message> {
    ...
    public void validate() throws BotArgumentException {
        if (null == chatId) {
            throw new BotArgumentException("chatId must no be null");
        }
        if (null == messageId) {
            throw new BotArgumentException("messageId must no be null");
        }
