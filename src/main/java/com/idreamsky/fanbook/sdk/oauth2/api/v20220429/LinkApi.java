...
import com.idreamsky.fanbook.sdk.oauth2.model.v20220429.LinkResponse;
...
@Data
@Slf4j
public class LinkApi extends FanbookRestfulApi<LinkResponse> {
     ...
     */
    @Override
    public Class<LinkResponse> getResponseClass() {
